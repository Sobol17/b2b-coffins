...
export interface CategoryDto { id: number; title: string; parentId: number | null; productCount: number; minPriceMinor?: number; minAgencyPriceMinor?: number; }
