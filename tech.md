...
**DoD:** каждый примитив отрендерен в `kitchen-sink`, тач-цели не меньше 44 px, кит работает в мобильном вьюпорте и с клавиатуры. Установка на домашний экран демонстрируется в K6 вместе с манифестом и service worker.
