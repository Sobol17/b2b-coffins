<script lang="ts">
	...
	let items = $state<KanbanItem[]>([
		{ id: 1, status: 'new', title: 'З-1042', subtitle: 'Ритуальная служба «Пример»' },
...
<Showcase name="KanbanBoard">
	<div class="w-full">
		<KanbanBoard {columns} {items} onDrop={move} />
	</div>
</Showcase>
...
<Showcase name="KanbanCard">
	<KanbanCard item={{ id: 9, status: 'ready', title: 'З-1050', subtitle: 'Сосна' }} />
</Showcase>
